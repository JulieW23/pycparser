...
def t(x):
    return {
        ...
        c_ast.Compound: (lambda orig: mc.Block(tmap(orig.block_items), coord=orig.coord)),
        ...
        c_ast.FileAST: (lambda orig: mc.FileAST(tmap(orig.ext))),
        ...
        c_ast.UnaryOp: (lambda orig: mc.UnaryOp(v(orig.op), t(orig.expr))),
